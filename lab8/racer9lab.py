...
WIDTH, HEIGHT = 400, 600 #размер дисплея
#colors
BLACK = (0, 0, 0)
WHITE = (255, 255, 255)
RED = (255, 0, 0)
...
#добовление картинки заднего фона
pygame.display.set_caption('Street Racer v0')
background = pygame.image.load("image/stret.png")
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.speed = 5
        self.image = pygame.image.load('image/coin1.png')
